...
const ApplicantModal = ({ onClose, applicantData }: Props) => {
  return (
    <div
      className="flex max-h-[600] overflow-y-scroll justify-center items-center fixed top-[141px] left-0 w-full h-full bg-[rgba(0,0,0,0.37)]"
      onClick={onClose}
    >
      <div className="w-full min-h-screen relative">
        <div
          className="flex flex-col gap-40 items-end w-808 h-auto px-52 py-40 rounded-20 z-10 bg-gradient absolute left-1/2 -translate-x-1/2 top-64"
