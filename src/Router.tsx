...
const Router = () => {
  ...
  const routes_children = [
    ...
    { path: '/team-matching', element: <TeamMatching />, hasHeader: true, hasFooter: true },
    {
      path: '/team-matching/register',
      element: <IdeaRegister />,
      hasHeader: true,
      hasFooter: true,
    },
    { path: '/team-matching/apply', element: <ProjectApply />, hasHeader: true, hasFooter: true },
    {
      path: '/team-matching/apply-state',
      element: <ApplyState />,
      hasHeader: true,
      hasFooter: true,
    },
    ...
    { path: '/mypage/edit', element: <MyPageEdit />, hasHeader: true, hasFooter: true },
    { path: '/building', element: <Building />, hasHeader: true, hasFooter: true },
