...
const Articles = () => {
  ...
  const selectArticle = articles.slice(
    (pageIdx - 1) * PAGE_SIZE,
    (pageIdx - 1) * PAGE_SIZE + PAGE_SIZE
  );
  return (
    <div className="relative">
      <div className="flex flex-col items-center gap-52 bg-gray min-h-screen w-screen px-76 py-100">
        ...
        <Pagination length={Math.ceil(articles.length / PAGE_SIZE)} setPageIdx={setPageIdx} />
      </div>
      <button
