...
const Login = () => {
  return (
    <div className="flex items-center justify-between bg-signup-gradient min-h-screen w-full px-40 md:px-120 overflow-x-hidden">
      <div className="hidden md:block">
        <img src={BigKUITLogo} alt="KUIT Logo" className="min-w-[55rem]" />
      </div>
      <div className="text-left justify-between mx-auto md:mx-0">
